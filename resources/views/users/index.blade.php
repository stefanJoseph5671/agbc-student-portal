...
<body class="clickup-chrome-ext_installed">
    ...
    <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
        <div class="container-fluid">
            ...
            <a class="navbar-brand pt-0" href="{{ route('home') }}">
                <img src="{{ asset('argon') }}/img/brand/ag_logo.png" class="navbar-brand-img" alt="...">
            </a>
            <!-- User -->
                ...
                <div class="navbar-collapse-header d-md-none">
                    <div class="row">
                        <div class="col-6 collapse-brand">
                            <a href="{{ route('home') }}">
                                <img src="{{ asset('argon') }}/img/brand/ag_logo.png">
                            </a>
                        </div>
    ...
    <div class="main-content">
        ...
        <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
            <div class="container-fluid">
                <!-- Brand -->
                <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="{{ route('home') }}">User Management</a>
                <!-- User -->
            ...
            <footer class="footer">
                <div class="row align-items-center justify-content-center">
                    <div class="copyright text-center text-xl-left text-muted">
                        &copy; {{ now()->year }} <span class="font-weight-bold ml-1">Assemblies Of God Ceylon Bible College</span>
                    </div>
                </div>
            </footer>
        </div>
